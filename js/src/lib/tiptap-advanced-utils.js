 ...
 */
export function hasContentAbove(editor) {
 ...
 */
export function getSelectedDOMElement(editor) {
 ...
 */
export function getClosestBlockNode(editor) {
 ...
 */
export function getClosestNodeByName(editor, nodeName) {
 ...
 */
export function getAnchorNodeAndPos(editor, allowEmptySelection = true) {
  if (!editor) return null
 ...
 */
export function selectionHasText(editor) {
