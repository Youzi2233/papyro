...
const TIPTAP_COMMAND_PANEL_REQUIREMENTS = [
  ...
  ["Tiptap Papyro table handle visual shell", ".tiptap-table-handle-menu::before", "width: 1.45rem"],
  ["Tiptap Papyro table handle transparent hitbox", ".tiptap-table-handle-menu", "background: transparent"],
  ...
  ["Tiptap table menu dedicated surface", ".tiptap-menu-content.tiptap-table-menu-content", "var(--tiptap-card-bg-color"],
  ["Tiptap table menu dedicated shadow", ".tiptap-menu-content.tiptap-table-menu-content", "--mn-shadow-menu"],
  ["Tiptap table menu direct panel radius", ".tiptap-table-menu-content > .tiptap-combobox-list", "calc(var(--mn-tiptap-menu-radius"],
  ...
  ["Tiptap table menu hover rail", ".tiptap-table-menu-content .tiptap-button:hover:not([disabled])", "linear-gradient"],
