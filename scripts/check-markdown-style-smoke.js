...
const TIPTAP_COMMAND_PANEL_REQUIREMENTS = [
  ...
  ["Tiptap table menu opaque surface", ".tiptap-menu-content.tiptap-table-menu-content", "background-color: var(--tiptap-card-bg-color"],
  ["Tiptap table menu viewport guard", ".tiptap-table-menu-content .tiptap-combobox-list", "max-width: min(16rem"],
  ["Tiptap table menu text clipping", ".tiptap-table-menu-content .tiptap-button-text", "text-overflow: ellipsis"],
