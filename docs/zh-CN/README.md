...
- Tiptap runtime 行为：`js/src/editor-runtime.ts`、`js/src/tiptap-*.js`、`js/src/tiptap-react/`、`js/src/editor-host-runtime.js`、`js/src/editor-runtime-contract.ts` 或 `js/src/editor-runtime-bootstrap.ts` 中的共享 helper
