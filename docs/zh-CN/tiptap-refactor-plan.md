...
| 维度 | 当前状态 | 目标状态 |
|------|---------|---------|
| 语言 | 混合 TypeScript，且截至 2026-05-13 `js/src/` 下仍有 50 个生产 `.js`/`.jsx` 文件 | TypeScript (.ts/.tsx) |
