...
- [x] Pipe tables become editable tables with slash/`+` table-size insertion, row/column edge selection handles, row/column operations, table-edge quick add controls, header toggles, cell merge/split, cell navigation, repair commands, and table deletion.
