...
| `SegmentedControl` | Exists | `primitives/forms.rs` owns small enumerations such as theme, view mode, and file-tree sorting, including optional per-option classes for compact product surfaces. Add disabled options if needed. |
